...
urlpatterns = [
    ...
    url(r'^list/(?P<list_uuid>[^/]+)/import-mailchimp$',views.SubscriberListImportCSV.as_view(), name='subscriber-management-list-import-mailchimp'),
    url(r'^list/(?P<uuid>[^/]+)/import-text$',views.SubscriberListImportText.as_view(), name='subscriber-management-list-import-text'),
